...
class IssueHandler {
  ...
  async executeGitCommentCreation () {
    ...
    // Add await here when validation below is fixed see L137
    this.createFailureLabel()
  ...
  async createFailureLabel () {
    ...
    if (labelConfig.enabled && this.issue_list.issues !== '') {
      ...
      // TODO: Don't always attempt to create label
      return this.context.github.issues.createLabel(params)
    }
  }
