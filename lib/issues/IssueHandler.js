...
class IssueHandler {
  ...
  async validateLabelPopulation () {
    ...
    if (!Util.getUndefined(labelConfig)) {
  ...
  async validateTitlePrefix () {
    ...
    if (!Util.getUndefined(prefixConfig) && prefix != null) {
  ...
  async validateTitleSuffix () {
    ...
    if (!Util.getUndefined(suffixConfig) && suffix != null) {
  ...
  async validateMilestoneAssignment () {
    ...
    if (!Util.getUndefined(milestoneConfig)) {
  ...
  async validateAsigneePopulation () {
    ...
    if (!Util.getUndefined(assigneePopulationConfig)) {
